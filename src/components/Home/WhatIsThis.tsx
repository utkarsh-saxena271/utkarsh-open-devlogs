...
export default function WhatIsThis() {
  return (
    <div className="mb-10 py-20 flex flex-col items-center text-center px-6 border-b border-slate-600/30">
      <h2 className={`${montserrat.className} mb-6 text-5xl font-extralight`}>
        What is this?
      </h2>

      <p className={`${roboto.className} mb-8 max-w-3xl text-lg text-slate-200`}>
      ...
      <p className={`${roboto.className} mb-14 max-w-3xl text-lg text-slate-200`}>
