...
export default function OpenSourceNote() {
  return (
    <section className="px-6 max-w-4xl mx-auto">
      ...
      <p className={`${roboto.className} mb-4 text-md sm:text-lg md:text-xl leading-relaxed`}>
      ...
      <p className={`${roboto.className} mb-6 text-md sm:text-lg md:text-xl leading-relaxed`}>
      ...
      <div className="text-center">
        <Link
          ...
          target="_blank"
          className="inline-block bg-green-700 text-white px-6 py-3 rounded-lg text-md md:text-lg font-medium hover:bg-green-800 transition-colors"
        >
