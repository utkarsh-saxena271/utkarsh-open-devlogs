...
export default function Hero() {
  return (
    <div className="h-140 flex flex-col items-center justify-center gap-10 border-b border-slate-600/30">
      <div className="w-200 text-center flex flex-col gap-6 justify-center px-10 ">
        <h1 className={`${montserrat.className} font-medium text-6xl`}>
          Utkarsh Open DevLogs
        </h1>
        <h1 className={`${roboto.className} font-extralight text-4xl`}>
          Building in public — daily dev logs, simple explanations, real code.
        </h1>
        <p className={`${roboto.className} font-thin text-lg`}>
          An open-source learning space where I document what I learn every day, in simple language with practical examples.
        </p>
      </div>
      <div className={`${roboto.className} font-thin flex flex-row items-center justify-center gap-10`}>
        <Link
          href="/devlogs"
